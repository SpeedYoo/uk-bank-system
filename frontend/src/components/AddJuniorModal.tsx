                ...
                {step === 'info' && (
                    <form onSubmit={handleCreateAccount}>
                        <div className="space-y-5 mb-8">
                            <div>
                                ...
                                <div className="relative group">
                                    ...
                                    <input type="text" value={firstName} onChange={(e) => setFirstName(e.target.value)}
                                        className="w-full bg-[#0B0E14] border border-gray-800 rounded-2xl py-4 pr-5 pl-12 text-white font-medium focus:outline-none focus:border-purple-500/50 transition-all" />
                                </div>
                            </div>
                            <div>
                            ...
                            <div>
                                <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-2 block ml-1">Date of Birth</label>
                                <div className="relative group">
                ...
                {step === 'credentials' && (
                    <form onSubmit={handleSetCredentials}>
                        ...
                        <div className="space-y-5 mb-6">
                            <div>
                                <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-2 block ml-1">Email Address</label>
                                <div className="relative group">
                            ...
                            <div>
                                <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-2 block ml-1">Password</label>
                                <div className="relative group">
                                    ...
                                    <input type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} required
                                        className="w-full bg-[#0B0E14] border border-gray-800 rounded-2xl py-4 pr-12 pl-12 text-white font-medium focus:outline-none focus:border-purple-500/50 transition-all" />
