...
const ConfirmActionModal: React.FC<ConfirmActionModalProps> = ({ 
    ...
    return (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            <div className="bg-[var(--bg-surface)] border border-[var(--border)] w-full max-w-sm rounded-[2rem] p-8 shadow-2xl relative overflow-hidden animate-in zoom-in-95 duration-200">
                <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-[var(--text-secondary)] text-sm leading-relaxed mb-8">{message}</p>
